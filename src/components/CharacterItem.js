...
function CharacterItem({eachCharacter}) {
    ...
    <img className="main__section2--li--img" src={eachCharacter.image} alt={`Foto de ${eachCharacter.name}`} />
    ...
    <p className="main__section2--li--p2">Especie:{eachCharacter.species}</p>
